...
- Use =mRemoteNG= with Putty to run Doom, to copy from Windows and paste with right mouse.
- Use =Shift= + Mouse Right Click to paste in Doom Emacs when using Putty to remote Linux
